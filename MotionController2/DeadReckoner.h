...
public:
	DeadReckoner(volatile unsigned long *, volatile unsigned long *, double, double, double, double);
...
private:
	...
	double ticksPerRevL, ticksPerRevR; // Number of tick registers per second of the encoder.
	...
	double theta;
	double toRadPerSecL, toRadPerSecR; // ticks/microsecond to rad/s conversion factor
